...
impl Manifest {
    ...
    pub fn to_toml(&self, root_path: &Utf8Path) -> String {
        ...
        buffer.push_str(
            "# This file was generated by Rakun
    ...
    fn manifest_toml_format() {
        let manifest = Manifest {
            requirements: [
                ...
                ("rakun_stdlib".into(), Requirement::hex("~> 0.17")),
                ("rakununit".into(), Requirement::hex("~> 0.1")),
            ]
            .into(),
            packages: vec![
                ManifestPackage {
                ...
                ManifestPackage {
                    ...
                    build_tools: ["rakun".into()].into(),
                    otp_app: None,
                    requirements: vec!["rakun_stdlib".into()],
                    source: ManifestPackageSource::Hex {
        ...
        assert_eq!(
            buffer,
            r#"# This file was generated by Rakun
# You typically do not need to edit this file

packages = [
  { name = "aaa", version = "0.4.0", build_tools = ["rebar3", "make"], requirements = ["rakun_stdlib", "zzz"], otp_app = "aaa_app", source = "hex", outer_checksum = "0316" },
  { name = "awsome_local1", version = "1.2.3", build_tools = ["rakun"], requirements = [], source = "local", path = "../path/to/package" },
  { name = "awsome_local2", version = "1.2.3", build_tools = ["rakun"], requirements = [], source = "git", repo = "https://github.com/rakun-lang/rakun.git", commit = "bd9fe02f72250e6a136967917bcb1bdccaffa3c8" },
  { name = "rakun_stdlib", version = "0.17.1", build_tools = ["rakun"], requirements = [], source = "hex", outer_checksum = "0116" },
  { name = "rakununit", version = "0.4.0", build_tools = ["rakun"], requirements = ["rakun_stdlib"], source = "hex", outer_checksum = "032E" },
...
awsome_local2 = { git = "https://github.com/rakun-lang/rakun.git" }
rakun_stdlib = { version = "~> 0.17" }
rakununit = { version = "~> 0.1" }
zzz = { version = "> 0.0.0" }
"#
        );
    }
