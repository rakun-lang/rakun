# Contributing to Rakun

Thanks for contributing to Rakun!

Before continuing please read our [code of conduct][code-of-conduct] which all
contributors are expected to adhere to.

[code-of-conduct]: https://github.com/rakun-lang/rakun/blob/main/CODE_OF_CONDUCT.md


## Contributing bug reports

If you have found a bug in Rakun please check to see if there is an open
...
[issues]: https://github.com/rakun-lang/rakun/issues
...
Code changes to Rakun are welcomed via the process below.
...
2. Open a GitHub pull request with your changes and ensure the tests and build
   pass on CI.
3. A Rakun team member will review the changes and may provide feedback to
...
If you are using the Nix package manager, there's a [rakun-nix flake](https://github.com/vic/rakun-nix)
you can use for running any Rakun version or quickly obtaining a development environment for Rakun.
...
Here are some tips and guidelines for writing Rust code in the Rakun compiler:

The `RAKUN_LOG` environment variable can be used to cause the compiler to
